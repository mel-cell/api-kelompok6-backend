...
class AddSecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $response->headers->set('Permissions-Policy', 'geolocation=(), microphone=(), camera=(), payment=(), usb=(), magnetometer=(), accelerometer=()');
        ...
        if ($request->is('/') || $request->is('api/documentation') || $request->is('docs*') || $request->is('docs/*')) {
