...
class PostController extends Controller
{
    ...
    public function acceptAnswer(Request $request, string $postId, string $commentId): JsonResponse
    {
        ...
        if ($post->user_id !== $request->user()->id) {
            return response()->json(['message' => 'Hanya pemilik post yang bisa accept answer'], 403);
        }
        ...
        return response()->json(['message' => 'Jawaban diterima']);
    }
    ...
    public function toggleBookmark(Request $request, string $id): JsonResponse
    {
        ...
        if ($existing) {
            ...
            return response()->json(['message' => 'Bookmark dihapus', 'is_bookmarked' => false]);
        }
        ...
        return response()->json(['message' => 'Post di-bookmark', 'is_bookmarked' => true]);
    }
